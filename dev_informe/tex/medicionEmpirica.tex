...
Obtenemos que el gráfico se puede ajustar a la recta $y = 4.54e^{-07}x + 0.25$, con un error cuadrático medio de 0.06. Por lo tanto, podemos verificar lo que ya vimos en la sección 3, que el orden es lineal \textbf{O(n)}.
